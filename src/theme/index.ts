...
export const colorSurfaceTertiaryHover =
  'var(--colorSurfaceTertiaryHover, rgba(157, 164, 178, 0.35))';
export const colorSurfaceTertiaryActive =
  'var(--colorSurfaceTertiaryActive, rgba(157, 164, 178, 0.5))';

export const colorSurfaceInverseStandard = 'var(--colorSurfaceInverseStandard, #1F1F1F)';
...
export const colorStrokeInverseStandard = 'var(--colorStrokeInverseStandard, #3A3A3A)';
